...
public class secondtable extends javax.swing.JFrame {
     ...
     */
    public static float[][] lt = new float[50][50];
    public static int l;
    public secondtable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        leadtime = new javax.swing.JTextField();
        ...
        jLabel1.setText("Enter a number of lead time :");
        ...
        jLabel2.setText("Enter the frequency (order) :");

        jButton1.setText("lead time table");
        ...
        jButton2.setText("Continue to last table");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(44, 44, 44)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(orders, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(leadtime, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(225, 225, 225)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		l = Integer.parseInt(leadtime.getText());
		for(int i = 0; i < l; i++) {
			lt[i][0] = i + 1;
		}
		...
		for(int i = 0; i < l; i++) {
			lt[i][1] = Float.valueOf(OrdersArray[i]);
		}
    ...
    private javax.swing.JTextField leadtime;
